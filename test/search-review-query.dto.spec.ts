...
describe('SearchReviewQueryDto', () => {
  ...
  it('should pass when content_contains is at the 200-char limit', () => {
    expect(validate({ content_contains: 'a'.repeat(200) })).toHaveLength(0);
  });

  it('should fail when content_contains exceeds 200 chars', () => {
    expect(
